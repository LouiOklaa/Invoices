                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="section" class="form-control select2" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option selected="true" disabled="disabled">حدد القسم</option>
                ...
                if (SectionId) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('select[name="product"]').append('<option value="' + AllProducts + '">' + AllProducts + '</option>');
