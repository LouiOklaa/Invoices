...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">المستخدمين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ معلومات المستخدم
                </span>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-right">
                                            ...
                                            <h2 class="mb-0 tx-22 mb-1 mt-1">{{number_format(\App\Invoices::withTrashed()->where('created_by' , '=' , $user->name)->count())}}</h2>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-left">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-right">
                                            ...
                                            <h2 class="mb-0 tx-22 mb-1 mt-1">{{number_format(\App\Invoices_Details::where('user' , '=' , $user->name)->where('value_status' , '=' , 1)->count())}}</h2>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-left">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-right">
                                            ...
                                            <h2 class="mb-0 tx-22 mb-1 mt-1">{{number_format(\App\Invoices_Details::where('user' , '=' , $user->name)->where('value_status' , '=' , 3)->count())}}</h2>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-left">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-right">
                                            ...
                                            <h2 class="mb-0 tx-22 mb-1 mt-1">{{number_format(\App\Invoices::onlyTrashed()->where('created_by' , '=' , $user->name)->count())}}</h2>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-left">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="text-right">
                                            ...
                                            <h2 class="mb-0 tx-22 mb-1 mt-1">{{number_format(\App\Invoices_Attachments::where('created_by' , '=' , $user->name)->count())}}</h2>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="text-left">
