            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        @endcan
                        @can('تصدير EXCEL')
                            <a class="modal-effect btn btn-rounded btn-success" href="{{ url('Export_Invoices') }}/{{ 2 }}" style="color:white; width: 170px; height: 40px; margin-right: 10px;"><i class="fas fa-file-download"></i>&nbsp &nbsp;تصدير EXCEL</a>
                        @endcan
                    </div>
                </div>
                <div class="card-body">
