...
@section('title')
    الفواتير المدفوعة جزئيا - لؤي سوفت
@stop
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        @endcan
                        @can('تصدير EXCEL')
                            <a class="modal-effect btn btn-rounded btn-success" href="{{ url('Export_Invoices') }}/{{ 4 }}"
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            ...
                            <tbody>
                                <?php $i=0?>
                                @foreach($partial_invoices as $one)
                                    <?php $i ++?>
                                    <tr>
                                        <td>{{$i}}</td>
                                        <td>
                                        ...
                                        <td>{{$one->value_VAT}}</td>
                                        <td>{{$one->total}}</td>
                                        <td><label class="badge badge-warning" style="color: white;">{{$one->status}}</label></td>
                                        @if($one->note == NULL)
